...
require_once APPLICATION_HOME.'/vendor/google/apiclient/src/Google/autoload.php';
 ...
 */
//$writer = new Blossom\Classes\Log\SkidderWriter('http://localhost/skidder/home.php', 100 );
